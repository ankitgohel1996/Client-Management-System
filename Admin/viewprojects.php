...
if($result->num_rows)
{
	while($row=$result->fetch_assoc())
	{
		...
		echo '<td><a href="deleteproject.php?userid=' . $row['projectid'] . '">Delete</a></td>';
		echo '<td><a href="viewtasks.php?userid=' . $row['projectid'] . '">Tasks</a></td>';
		echo "</tr>";
	}
}

echo "</table>";
echo '<p><a href="addproject.php?userid='$userid'">Add a new project</a></p>';
?>
